/* 링크
http://localhost:8888/ServletTest/T07ServletContextTest
*/
...
1. 서블릿 프로그램이 컨테이너와 정보를 주고 받기 위한 기능(메소드)를 제공한다.
 ...
 */
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("서블릿 API의 마이너 버전 정보 : " + ctx.getMajorVersion());
