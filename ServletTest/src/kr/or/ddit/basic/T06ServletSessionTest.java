/* 링크
http://localhost:8888/ServletTest/T06ServletSessionTest
*/
...
/* 세션(HttpSession) 객체
	...
	=> boolean값: true인 경우 => 세션 객체가 존재하지 않으면 새로 생성한다. (default도 true)
...
//		session.setMaxInactiveInterval(30);
		...
		out.print("<html><head><title>" + title + "</title></html>"
